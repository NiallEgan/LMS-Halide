#ifndef HALIDE_____laplace_h
#define HALIDE_____laplace_h
#include <stdint.h>
...
int laplace(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_laplace_buffer) HALIDE_FUNCTION_ATTRS;
int laplace_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *laplace_metadata() HALIDE_FUNCTION_ATTRS;
